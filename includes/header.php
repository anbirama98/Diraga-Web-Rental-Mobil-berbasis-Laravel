  ...
  <div class="default-header">
    <div class="container">
      <div class="row">
        ...
        <div class="logo"> <a href="index.php"><img src="assets/images/logo.png" alt="image" width="80%" style="margin-top: 0px;"></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">diragarentcar@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">For Services Call Us: </p>
              <a href="tel:61-1234-5678-09">+62 812-3490-8416</a> </div>
