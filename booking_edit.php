...
$maxFileSize = 5 * 1024 * 1024; // Maksimum 5 MB
	
if ($fileSize > $maxFileSize) {
// Ukuran file terlalu besar
echo "Ukuran file terlalu besar. Maksimum ukuran file adalah 5MB.";
// Tambahkan kode lain di sini sesuai kebutuhan, seperti penghentian proses atau pesan kesalahan.
} else {
// Lanjutkan proses upload gambar
// Misalnya, pindahkan file ke direktori tujuan
move_uploaded_file($file['tmp_name'], "lokasi_tujuan/".$fileName);
// Lakukan operasi lain setelah upload sukses
}
}
	?>
?>
	...
	<div class="user_profile_info">	
        ...
        <form method="post" action="update_sewa.php" name="sewa" onSubmit="return valid();" enctype="multipart/form-data"> 
			...
			<label>Upload Bukti Pembayaran</label><br/>
				<input type="file" class="form-control" name="img1" accept="image/*" required maxlength="50">
			</div>											
